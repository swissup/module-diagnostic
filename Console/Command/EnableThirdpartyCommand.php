...
class EnableThirdpartyCommand extends AbstractStyledCommand
{
    ...
    {
        $this->setName('swissup:info:enable-thirdparty')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            if (!file_exists($stateFile)) {
                ...
                $output->writeln('<fg=yellow>⚠️  The state file is created when you run swissup:info:disable-thirdparty</>');
                $output->writeln('<fg=cyan>💡 You need to disable 3rd-party modules first before enabling them.</>');
                $output->writeln('');
            ...
            $this->displayModulesTable($output, $allThirdpartyModules, $savedState['enabled_modules'], 'MODULES TO ENABLE');
            ...
            $this->displaySuccessBanner($output, '3rd-party modules enabled successfully!');
